...
// 🚀 DIUBAH: Menggunakan model stabil gemini-2.5-flash untuk akurasi pengolahan visual Free Tier yang lebih andal
...
async function startSystem() {
    ...
    sock.ev.on('messages.upsert', async ({ messages }) => {
        ...
        if (tpmState[senderKey]) {
            ...
            // OCR MULTIMODAL PHOTO CAPTURE STATE (DENGAN CONSOLE LOG SINKRONISASI)
            if (current.step === "OCR_PHOTO") {
                ...
                try {
                    ...
                    // Mengirimkan pesan error asli ke WhatsApp agar operator tahu letak kerusakannya
